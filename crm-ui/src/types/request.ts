...
export const RequestUtils = {
  ...
  backendToFrontendStatus(status: RequestStatus): 'pending' | 'in-progress'  | 'completed'  {
    switch (status) {
      case 'TODO':
        return 'pending';
      case 'IN_PROGRESS':
  ...
  frontendToBackendStatus(status: 'pending' | 'in-progress'  | 'completed' ): RequestStatus {
    switch (status) {
      case 'pending':
        return 'TODO';
      case 'in-progress':
  ...
  toDisplayView(request: SeniorRequestView, additionalInfo?: {
    seniorName?: string;
    seniorPhone?: string;
    seniorEmail?: string;
    seniorAddress?: string;
  ...
  fromDtoToDisplayView(request: SeniorRequestDto, additionalInfo?: {
    seniorName?: string;
    seniorPhone?: string;
    seniorEmail?: string;
    seniorAddress?: string;
